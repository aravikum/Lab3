...
The examples today will look at the change in fermentation products across study weeks (before and during supplement consumption), and between the different types of fiber supplements. Run the code below to import a curated version of the scfa data,cc in which weekly averages (mmol/kg SCFA) have already been calculated. 
ccccc
...
butyrate_long %>%
  ...
  ggplot(aes(x = frequency, 
             y = butyrate_mean)) + 
  geom_violin(aes(color = frequency)) + geom_jitter(aes(color = frequency))
```
